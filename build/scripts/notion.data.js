...
var masterId = transformStringIntoId('f058d64ad56b4f318ec58ddeb26625ff');
...
//     }
// })()
function retrieveNotionData() {
    return __awaiter(this, void 0, void 0, function () {
        var data, blogEntryPage, postsWithRowData, transformedPosts;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, requestData()];
                case 1:
                    data = _a.sent();
                ...
                case 3: throw new Error('no data was retrieved');
            }
        });
    });
}
